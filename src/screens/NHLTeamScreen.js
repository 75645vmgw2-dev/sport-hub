...
export default function NHLTeamScreen({ team, onBack }) {
  ...
  async function fetchTeamData() {
    ...
    try {
      const [recentRes, upcomingRes, playersRes] = await Promise.all([
        fetch('https://v1.hockey.api-sports.io/games?league=57&season=2025&team='+team.id+'&last=10', { headers:H_NHL }),
        fetch('https://v1.hockey.api-sports.io/games?league=57&season=2025&team='+team.id+'&next=5', { headers:H_NHL }),
        fetch('https://v1.hockey.api-sports.io/players?team='+team.id+'&season=2025', { headers:H_NHL }),
      ]);
  ...
  async function fetchKazmoAnalysis() {
    ...
    try {
      ...
      const prompt = 'Tu es Kazmo, assistant IA sportif premium.\n' +
        'Fais une analyse complete de lequipe NHL : ' + team.name + '\n\n' +
        'Inclus : 1. Presentation 2. Saison en cours 3. Points forts/faibles 4. Joueurs cles 5. Perspectives\n\n' +
    ...
    try {
      ...
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          system:'Tu es Kazmo, expert NHL sur '+team.name+'. Reponds en '+langName+' de facon concise.',
      ...
      <View style={[styles.header, { borderBottomColor:C }]}>
        ...
        <View style={styles.headerCenter}>
          ...
          <View>
            ...
            <Text style={styles.headerLeague}>NHL 2025-26</Text>
          </View>
        </View>
        <View style={{ width:40 }} />
      </View>
          ...
          {tab === 'forme' && (
            <View>
              ...
              {recentSliced.length === 0 ? (
                ...
                const myScore = isHome ? g.scores.home : g.scores.away;
                ...
                return (
                  <View key={i} style={styles.playerRow}>
                    ...
                    <View style={{ flex:1 }}>
                      ...
                      <Text style={styles.playerInfo}>{pos}{nationality?' · '+nationality:''}</Text>
                    </View>
